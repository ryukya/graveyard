...
<div class="panel panel-default">
  ...
  <div class="col-sm-10"><p> Grave Yard.co</p>
   ...
   <div class="col-sm-10"><p> Grave Yard.co</p> </div> </div>
  ...
  <div class="form-group">
   <label for="firstname" class="col-sm-2 control-label">Ijin Usaha</label>  <div class="col-sm-10"><p> Grave Yard.co</p> 
  </div> </div>
	<div class="form-group"> 
	<div class="col-sm-offset-2 col-sm-10"> 
	<button type="submit" class="btn btn-default">Print</button> </div> </div> </form>
</div>
</div>
